	 ...
	 * @brief Declarations for API resources for PBKDF2-SHA-1 key derivation.
	 * @author Jack (jakcron)
	 * @version 0.1
	 * @date 2020/06/06
	 **/
...
namespace tc { namespace crypto {
	 ...
	 * @brief Class for deriving a key using PBKDF2-SHA-1.
	 * 
	 * @details This class derives a key using PBKDF2-SHA-1.
	 * For more information refer to @ref Pbkdf2KeyDeriver.
	 */
using Pbkdf2Sha1KeyDeriver = Pbkdf2KeyDeriver<Sha1Generator>;

	/**
	 * @brief Utility function for deriving a key using PBKDF2-SHA-1.
	 * 
