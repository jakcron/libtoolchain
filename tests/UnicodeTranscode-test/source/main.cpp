...
static std::string kUtf8Str = "./ЀЁЂЃЄЅ-מבחן-тест-テスト.bin";
static std::u16string kUtf16Str = u"./ЀЁЂЃЄЅ-מבחן-тест-テスト.bin";
...
void testUtf8ToUtf16()
{
	try
	{
		...
		tc::unicode::transcodeUtf8ToUtf16(kUtf8Str, utf16_str);
...
void testUtf16ToUtf8()
{
	try
	{
		...
		tc::unicode::transcodeUtf16ToUtf8(kUtf16Str, utf8_str);
