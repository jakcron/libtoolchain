...
{
	std::cout << "[SandboxedIFileSystem] testSandboxRootPath : ";
	try
	{
...
void testCreateFile()
{
	std::cout << "[SandboxedIFileSystem] testCreateFile : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
void testOpenFile()
{
	std::cout << "[SandboxedIFileSystem] testOpenFile : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
void testRemoveFile()
{
	std::cout << "[SandboxedIFileSystem] testRemoveFile : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
{
	std::cout << "[SandboxedIFileSystem] testCreateDirectory : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
{
	std::cout << "[SandboxedIFileSystem] testdeleteDirectory : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
{
	std::cout << "[SandboxedIFileSystem] testGetDirectoryListing : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
{
	std::cout << "[SandboxedIFileSystem] testNavigateUpSandboxEscape : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
...
{
	std::cout << "[SandboxedIFileSystem] testOpenFileOutsideSandbox : ";
	try
	{
		class DummyFileSystem : public DummyFileSystemBase
		{
