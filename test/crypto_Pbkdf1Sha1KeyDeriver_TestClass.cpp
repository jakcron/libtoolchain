...
crypto_Pbkdf1Sha1KeyDeriver_TestClass::crypto_Pbkdf1Sha1KeyDeriver_TestClass() :
	mTestTag("tc::crypto::Pbkdf1Sha1KeyDeriver"),
	mTestResults()
{
}
...
void crypto_Pbkdf1Sha1KeyDeriver_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kMaxDerivableSize had value {:d}  (expected {:d})", tc::crypto::Pbkdf1Sha1KeyDeriver::kMaxDerivableSize, kExpectedMaxDerivableSize));
		}
...
void crypto_Pbkdf1Sha1KeyDeriver_TestClass::test_WillThrowExceptionOnZeroRounds()
{
	...
	try
	{
		...
		try 
		{
			...
			throw tc::TestException("DeriveKeyPbkdf1Sha1() Did not throw tc::crypto::CryptoException where the round count was set to zero.");
		}
		catch (const tc::crypto::CryptoException&) { /* do nothing */ }
		catch (const tc::Exception&)
		{
			throw tc::TestException("DeriveKeyPbkdf1Sha1() Threw the wrong exception where the round count was set to zero.");
		}
		...
		try 
		{
			...
			throw tc::TestException("Pbkdf1Sha1KeyDeriver::initialize() Did not throw exception where the round count was set to zero.");
		}
		catch (const tc::crypto::CryptoException&) { /* do nothing */ }
		catch (const tc::Exception&)
		{
			throw tc::TestException("Pbkdf1Sha1KeyDeriver::initialize() Threw the wrong exception where the round count was set to zero.");
		}
...
void crypto_Pbkdf1Sha1KeyDeriver_TestClass::test_WillThrowExceptionOnTooLargeDkSize()
{
	...
	try
	{
		...
		try 
		{
			...
			throw tc::TestException("DeriveKeyPbkdf1Sha1() Did not throw tc::crypto::CryptoException where the derived data length would exceed the maximum.");
		}
		catch (const tc::crypto::CryptoException&) { /* do nothing */ }
		catch (const tc::Exception&)
		{
			throw tc::TestException("DeriveKeyPbkdf1Sha1() Threw the wrong exception where the derived data length would exceed the maximum.");
		}	
		...
		try 
		{
			...
			throw tc::TestException("Pbkdf1Sha1KeyDeriver::getBytes() Did not throw tc::crypto::CryptoException where the derived data length would exceed the maximum.");
		} 
		catch (const tc::crypto::CryptoException&) { /* do nothing */ }
		catch (const tc::Exception&)
		{
			throw tc::TestException("Pbkdf1Sha1KeyDeriver::getBytes() Threw the wrong exception where the derived data length would exceed the maximum.");
		}
