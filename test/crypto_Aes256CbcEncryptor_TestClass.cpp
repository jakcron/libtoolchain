...
crypto_Aes256CbcEncryptor_TestClass::crypto_Aes256CbcEncryptor_TestClass() :
	mTestTag("tc::crypto::Aes256CbcEncryptor"),
	mTestResults()
{
}
...
void crypto_Aes256CbcEncryptor_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes256CbcEncryptor::kBlockSize, kExpectedBlockSize));
		}
		...
		{
			throw tc::TestException(fmt::format("kKeySize had value {:d} (expected {:d})", tc::crypto::Aes256CbcEncryptor::kKeySize, kExpectedKeySize));
		}
...
void crypto_Aes256CbcEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
	...
	try
	{
		...
		// create data
		tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes256CbcEncryptor::kBlockSize).pullData(0, tc::crypto::Aes256CbcEncryptor::kBlockSize);
