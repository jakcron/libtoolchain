...
crypto_Aes256EcbEncryptor_TestClass::crypto_Aes256EcbEncryptor_TestClass() :
	mTestTag("tc::crypto::Aes256EcbEncryptor"),
	mTestResults()
{
}
...
void crypto_Aes256EcbEncryptor_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes256EcbEncryptor::kBlockSize, kExpectedBlockSize));
		}
		...
		{
			throw tc::TestException(fmt::format("kKeySize had value {:d} (expected {:d})", tc::crypto::Aes256EcbEncryptor::kKeySize, kExpectedKeySize));
		}
...
void crypto_Aes256EcbEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
	...
	try
	{
		...
		// create data
		tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes256EcbEncryptor::kBlockSize).pullData(0, tc::crypto::Aes256EcbEncryptor::kBlockSize);
