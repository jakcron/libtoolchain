...
crypto_Aes128XtsEncryptor_TestClass::crypto_Aes128XtsEncryptor_TestClass() :
	mTestTag("tc::crypto::Aes128XtsEncryptor"),
	mTestResults()
{
}
...
void crypto_Aes128XtsEncryptor_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes128XtsEncryptor::kBlockSize, kExpectedBlockSize));
		}
		...
		{
			throw tc::TestException(fmt::format("kKeySize had value {:d} (expected {:d})", tc::crypto::Aes128XtsEncryptor::kKeySize, kExpectedKeySize));
		}
...
void crypto_Aes128XtsEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
	...
	try
	{
		...
		// create data
		tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes128XtsEncryptor::kBlockSize).pullData(0, tc::crypto::Aes128XtsEncryptor::kBlockSize);
