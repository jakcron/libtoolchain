...
void string_transcode_TestClass::testUtf8ToUtf16()
{
	...
	try
	{
		...
		tc::string::transcodeUTF8ToUTF16(kUtf8Str, utf16_str);
...
void string_transcode_TestClass::testUtf16ToUtf8()
{
	std::cout << "[tc::string::transcode] testUtf16ToUtf8 : ";
	try
	{
		std::string utf8_str;

		tc::string::transcodeUTF16ToUTF8(kUtf16Str, utf8_str);
