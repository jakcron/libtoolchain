...
crypto_Des56EcbEncryptor_TestClass::crypto_Des56EcbEncryptor_TestClass() :
	mTestTag("tc::crypto::Des56EcbEncryptor"),
	mTestResults()
{
}
...
void crypto_Des56EcbEncryptor_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kBlockSize had value {:d} (expected {:d})", tc::crypto::Des56EcbEncryptor::kBlockSize, kExpectedBlockSize));
		}
		...
		{
			throw tc::TestException(fmt::format("kKeySize had value {:d} (expected {:d})", tc::crypto::Des56EcbEncryptor::kKeySize, kExpectedKeySize));
		}
...
void crypto_Des56EcbEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
	...
	try
	{
		...
		// create data
		tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Des56EcbEncryptor::kBlockSize).pullData(0, tc::crypto::Des56EcbEncryptor::kBlockSize);
