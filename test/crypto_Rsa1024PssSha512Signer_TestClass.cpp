...
crypto_Rsa1024PssSha512Signer_TestClass::crypto_Rsa1024PssSha512Signer_TestClass() :
	mTestTag("tc::crypto::Rsa1024PssSha512Signer"),
	mTestResults()
{
}
...
const std::string& crypto_Rsa1024PssSha512Signer_TestClass::getTestTag() const
{
	return mTestTag;
}

const std::vector<ITestClass::TestResult>& crypto_Rsa1024PssSha512Signer_TestClass::getTestResults() const
{
	return mTestResults;
}
...
void crypto_Rsa1024PssSha512Signer_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa1024PssSha512Signer::kSignatureSize, kExpectedSignatureSize));
		}
