...
crypto_Rsa2048PssSha256Signer_TestClass::crypto_Rsa2048PssSha256Signer_TestClass() :
	mTestTag("tc::crypto::Rsa2048PssSha256Signer"),
	mTestResults()
{
}
...
const std::string& crypto_Rsa2048PssSha256Signer_TestClass::getTestTag() const
{
	return mTestTag;
}

const std::vector<ITestClass::TestResult>& crypto_Rsa2048PssSha256Signer_TestClass::getTestResults() const
{
	return mTestResults;
}
...
void crypto_Rsa2048PssSha256Signer_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa2048PssSha256Signer::kSignatureSize, kExpectedSignatureSize));
		}
