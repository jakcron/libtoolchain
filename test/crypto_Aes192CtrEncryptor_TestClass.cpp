...
crypto_Aes192CtrEncryptor_TestClass::crypto_Aes192CtrEncryptor_TestClass() :
	mTestTag("tc::crypto::Aes192CtrEncryptor"),
	mTestResults()
{
}
...
void crypto_Aes192CtrEncryptor_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kBlockSize had value {:d} (expected {:d})", tc::crypto::Aes192CtrEncryptor::kBlockSize, kExpectedBlockSize));
		}
		...
		{
			throw tc::TestException(fmt::format("kKeySize had value {:d} (expected {:d})", tc::crypto::Aes192CtrEncryptor::kKeySize, kExpectedKeySize));
		}
...
void crypto_Aes192CtrEncryptor_TestClass::test_DoesNothingWhenNotInit()
{
	...
	try
	{
		...
		// create data
		tc::ByteData control_data = tc::io::PaddingSource(0xee, tc::crypto::Aes192CtrEncryptor::kBlockSize).pullData(0, tc::crypto::Aes192CtrEncryptor::kBlockSize);
