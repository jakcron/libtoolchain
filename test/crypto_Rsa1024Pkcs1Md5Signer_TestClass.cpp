...
crypto_Rsa1024Pkcs1Md5Signer_TestClass::crypto_Rsa1024Pkcs1Md5Signer_TestClass() :
	mTestTag("tc::crypto::Rsa1024Pkcs1Md5Signer"),
	mTestResults()
{
}
...
void crypto_Rsa1024Pkcs1Md5Signer_TestClass::test_Constants()
{
	...
	try
	{
		...
		{
			throw tc::TestException(fmt::format("kSignatureSize had value {:d} (expected {:d}", tc::crypto::Rsa1024Pkcs1Md5Signer::kSignatureSize, kExpectedSignatureSize));
		}
